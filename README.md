Клиент заполняет Заявку, указывая количество мест в номере, класс апартаментов и время пребывания. Система выделяет наиболее подходящий из доступных Номеров. Администратор просматривает поступившую Заявку, и если предоплата была сделана утверждает Заявку, иначе если имеются причины, отказывает в заказе.
Задание
